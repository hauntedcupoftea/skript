...
import spacy
# some needed configuration for tensorflow
...
def attrSep(proc: spacy.tokens.doc.Doc) -> list:
    # a simple cosine similarity that compares vectors against the phrases we decided best suit our grading criteria
...
def analyse(data: list) -> list:
    ...
    for i in range(len(data)):
        # run all predefined cleaning functions and re-merge the transcript
...
# testing main function with memes lol
